...
namespace CSharpImageLibrary.Decoders
{
    ...
    /// </summary>
    public partial class TargaImage : IDisposable
    {
        private TGA_Header objTargaHeader = null;
        ...
        public TargaImage()
        {
            ...
            this.objTargaHeader = new TGA_Header();
